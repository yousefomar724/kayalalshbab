  ...
  const toggleTheme = () => {
    if (isDarkMode) {
      ...
      return (
        <div
          onClick={() => toggleDarkMode()}
          className="relative flex justify-between items-center py-2.5 px-4 rounded-br-md rounded-bl-md transition bg-gray-100 bg-opacity-500 shadow-sm text-gray-800 cursor-pointer"
        >
          <h1 className="text-xs md:text-md text-gray-600 font-semibold">
            وضع ليلي
          </h1>
